...
const faqs = [
  {
    ...
    answer: "ההרשמה פשוטה וקלה. אחרי ההרשמה תקבלו הדרכה מלאה וליווי אישי להתחלת השימוש במערכת."
  },
  {
    question: "האם המערכת מתאימה לבעלי נכס אחד?",
    answer: "בהחלט! המערכת מתאימה הן לבעלי נכס יחיד והן לבעלי תיקי נכסים גדולים. התמחור מותאם לכמות הנכסים."
  },
  {
  ...
  },
  {
    ...
    answer: "יש לנו מספר תוכניות תמחור המותאמות לצרכים שונים. ניתן להתחיל עם תקופת ניסיון חינמית."
  }
];
